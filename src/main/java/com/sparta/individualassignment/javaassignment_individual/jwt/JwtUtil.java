package com.sparta.individualassignment.javaassignment_individual.jwt;
...
public class JwtUtil {
    ...
    @Value("7Iqk7YyM66W07YOA7L2U65Sp7YG065+9U3ByaW5n6rCV7J2Y7Yqc7YSw7LWc7JuQ67mI7J6F64uI64ukLg==") // Base64 Encode 한 SecretKey, "beans.factory." 에 annotation 해야 함!
    ...
    // JMT 토큰 생성
    public String createToken(String comment_id, UserRoleEnum role) {
        Date date = new Date();

        return BEARER_PREFIX +
                Jwts.builder()
                        .setSubject(comment_id) // 사용자 식별자값(ID)
                        .claim(AUTHORIZATION_KEY, role) // 사용자 권한 (claim에 key, value를 넣을 수 있다)
                        .setExpiration(new Date(date.getTime() + TOKEN_TIME)) // (date.getTIme() = 현재시간, TOKEN_TIME = 만료시간
